<template>
          ...
          <form @submit.prevent="submit">
            ...
            <div v-if="currentStep === 1">
              <div class="mb-3">
                ...
                <input v-model="registroReemplazo.rut_saliente" type="text" class="form-control" id="username" autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="first_name" class="form-label">Nombre</label>
                <input v-model="registroReemplazo.nombre_saliente" type="text" class="form-control" id="first_name" autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="last_name" class="form-label">Apellido</label>
                <input v-model="registroReemplazo.apellido_saliente" type="text" class="form-control" id="last_name" autocomplete="off">
              </div>
            ...
            <div v-if="currentStep === 2">
              <div class="mb-3">
                <label for="username" class="form-label">Rut</label>
                <input v-model="registroReemplazo.rut_entrante" type="text" class="form-control" id="username" autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="first_name" class="form-label">Nombre</label>
                <input v-model="registroReemplazo.nombre_entrante" type="text" class="form-control" id="first_name" autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="last_name" class="form-label">Apellido</label>
                <input v-model="registroReemplazo.apellido_entrante" type="text" class="form-control" id="last_name" autocomplete="off">
              </div>
              <button @click.prevent="nextStep" class="btn btn-primary">Siguiente</button>
            </div>
            <div v-if="currentStep === 2">
            ...
            <div v-if="currentStep === 3">
              <div class="mb-3">
                ...
                <input v-model="registroReemplazo.tipo_turno" type="text" class="form-control" id="username" autocomplete="off">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input v-model="registroReemplazo.servicio" type="text" class="form-control" id="last_name" autocomplete="off">
              </div>
    ...
    import { useAuthStore, type RegisterDataReemplazo } from '../../stores/auth';
